...
- Contribute a [dev container definition](https://aka.ms/vscode-dev-containers) for others to use.
- Help [shape the direction](https://github.com/microsoft/dev-container-spec) of dev containers and the dev container CLI.
